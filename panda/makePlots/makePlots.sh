...
if [ $NSEL == 'random' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WZ}","GeVBINROOT","done_ana/histossww_'${YEAR}'_138'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_fullmtwz",1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_138'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
