...
if [ $NSEL == 'random' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_118'${fidAnaName}'.root","ssww_wwsel_mjjall_mt",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_119'${fidAnaName}'.root","ssww_wwsel_mjjlow_mt",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_120'${fidAnaName}'.root","ssww_wwsel_mjjhigh_mt",0, '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_121'${fidAnaName}'.root","ssww_wzsel_mjjall_mt",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_122'${fidAnaName}'.root","ssww_wzsel_mjjlow_mt",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_123'${fidAnaName}'.root","ssww_wzsel_mjjhigh_mt",0, '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
