...
if [ $NSEL == 'random' ]; then
  ...
  if [ $YEAR != '2019' ] && [ $NSEL == 'random' ]; then
    export mlfitResult="done_ana/../ana_ssww/fitDiagnosticsssww_${YEAR}_wwwz_obs.root";
    export channelName="ch1";
  fi

  #hadd -f done_ana/histossww_2019_118_t2_2p9.root histossww_201?_118.root
  #hadd -f done_ana/histossww_2019_128_t2_2p9.root histossww_201?_128.root
  ...
  #hadd -f done_ana/histossww_2019_118_s0_20.root histossww_201?_118.root
  #hadd -f done_ana/histossww_2019_128_s0_20.root histossww_201?_128.root
  ...
  #hadd -f done_ana/histossww_2019_118_aqgc.root done_ana/histossww_2019_118.root done_ana/histossww_2019_118_t2_2p9.root
  #hadd -f done_ana/histossww_2019_128_aqgc.root done_ana/histossww_2019_128.root done_ana/histossww_2019_128_t2_2p9.root
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WZ}","GeVBINROOT","done_ana/histossww_'${YEAR}'_118'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_fullmtwz",1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_118'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20.0 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WW}","GeVBINROOT","done_ana/histossww_'${YEAR}'_128'${fidAnaName}'_aqgc.root","ssww_wwsel_aqgc_fullmtww",1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_128'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20.0 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}"    ,"GeVBINROOT","done_ana/histossww_'${YEAR}'_136'${fidAnaName}'_aqgc.root","ssww_wwsel_aqgc_mll"     ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_136'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20.0 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}"     ,"GeVBINROOT","done_ana/histossww_'${YEAR}'_137'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_mt"      ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_137'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20.0 TeV^{-4}")';
  ...
  for NJET in 0 1; do
    ...
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"ZH selection #phi","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_73.root","zh_zhsel_phi_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
    root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{llj}/ H_{T}^{llj}","","done_ana/histoZH_'${YEAR}'_'${NJET}'j_74.root","zh_zhsel_vtptht_'${NJET}'j",0,'${YEAR}',"Z(ll)H_{125}(inv.)",'${sf_dy}',0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BINROOT","done_ana/histossww_'${YEAR}'_77'${fidAnaName}'.root","ssww_wzsel_bdt",0,'${YEAR}',"H_{125}",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"#Delta#eta_{jj}","ROOT","done_ana/histossww_'${YEAR}'_5'${fidAnaName}'.root","ssww_wwsel_detajj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}"    ,"GeVBIN","done_ana/histossww_'${YEAR}'_134'${fidAnaName}'_aqgc.root","ssww_wwsel_aqgc_mll"     ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_134'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WW}","GeVBIN","done_ana/histossww_'${YEAR}'_135'${fidAnaName}'_aqgc.root","ssww_wwsel_aqgc_fullmtww",1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_135'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m^{WW}"    ,"GeVBIN","done_ana/histossww_'${YEAR}'_136'${fidAnaName}'_aqgc.root","ssww_wwsel_aqgc_fullmww" ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_136'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WZ}","GeVBIN","done_ana/histossww_'${YEAR}'_137'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_mtwz"    ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_137'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}^{WZ}","GeVBIN","done_ana/histossww_'${YEAR}'_138'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_fullmtwz",1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_138'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m^{WZ}"    ,"GeVBIN","done_ana/histossww_'${YEAR}'_139'${fidAnaName}'_aqgc.root","ssww_wzsel_aqgc_fullmwz" ,1,'${YEAR}',"f_{T2}/#Lambda^{4} = 2.9 TeV^{-4}",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"done_ana/histossww_'${YEAR}'_139'${fidAnaName}'_s0_20.root","f_{S0}/#Lambda^{4} = 20 TeV^{-4}")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{j}","","done_ana/histossww_'${YEAR}'_25'${fidAnaName}'.root","ssww_wwsel_njet",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{j}","","done_ana/histossww_'${YEAR}'_29'${fidAnaName}'.root","ssww_wzsel_njet",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"z_{3l}^{*}","","done_ana/histossww_'${YEAR}'_47'${fidAnaName}'.root","ssww_wzsel_zvvstar",0,'${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  if [ $NSEL == 'long' ]; then
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Output fit","BIN","done_ana/histossww_'${YEAR}'_140'${fidAnaName}'.root","ssww_datacard",1,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BIN","done_ana/histossww_'${YEAR}'_89'${fidAnaName}'.root","ssww_wwsel_bdt",1,'${YEAR}',"'${legendBSM}'",1.0,1,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  else
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Output fit","BIN","done_ana/histossww_'${YEAR}'_140'${fidAnaName}'.root","ssww_datacard",0,'${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
...
exit;
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_15'${fidAnaName}'.root","ssww_wwsel_ptj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_16'${fidAnaName}'.root","ssww_btagsel_ptj",0,'${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_17'${fidAnaName}'.root","ssww_zzsel_ptj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_18'${fidAnaName}'.root","ssww_wzbsel_ptj",0, '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{j}","GeV","done_ana/histossww_'${YEAR}'_19'${fidAnaName}'.root","ssww_wzsel_ptj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"N_{#tau}","","done_ana/histossww_'${YEAR}'_515253'${fidAnaName}'.root","ssww_wwselnminus1_ntau",0,'${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"BDT score","BIN","done_ana/histossww_'${YEAR}'_90'${fidAnaName}'.root","ssww_btagsel_bdt",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_97'${fidAnaName}'.root","ssww_mm_presel_mjj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_100'${fidAnaName}'.root","ssww_mm_presel_detajj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_103'${fidAnaName}'.root","ssww_mm_presel_zstar",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_106'${fidAnaName}'.root","ssww_mm_presel_ptj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_109'${fidAnaName}'.root","ssww_mm_presel_etaj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_112'${fidAnaName}'.root","ssww_mm_presel_ptl",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_115'${fidAnaName}'.root","ssww_mm_presel_etal",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_98'${fidAnaName}'.root","ssww_ee_presel_mjj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_101'${fidAnaName}'.root","ssww_ee_presel_detajj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_104'${fidAnaName}'.root","ssww_ee_presel_zstar",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_107'${fidAnaName}'.root","ssww_ee_presel_ptj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_110'${fidAnaName}'.root","ssww_ee_presel_etaj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_113'${fidAnaName}'.root","ssww_ee_presel_ptl",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_116'${fidAnaName}'.root","ssww_ee_presel_etal",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"m_{jj}","GeV","done_ana/histossww_'${YEAR}'_99'${fidAnaName}'.root","ssww_em_presel_mjj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#Delta#eta_{jj}","","done_ana/histossww_'${YEAR}'_102'${fidAnaName}'.root","ssww_em_presel_detajj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"Max z^{*}","","done_ana/histossww_'${YEAR}'_105'${fidAnaName}'.root","ssww_em_presel_zstar",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"p_{T}^{j}","","done_ana/histossww_'${YEAR}'_108'${fidAnaName}'.root","ssww_em_presel_ptj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,5,"#eta^{j}","","done_ana/histossww_'${YEAR}'_111'${fidAnaName}'.root","ssww_em_presel_etaj",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,10,"p_{T}^{l}","GeV","done_ana/histossww_'${YEAR}'_114'${fidAnaName}'.root","ssww_em_presel_ptl",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,2,"|#eta^{l}|","","done_ana/histossww_'${YEAR}'_117'${fidAnaName}'.root","ssww_em_presel_etal",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}')';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_118'${fidAnaName}'.root","ssww_wwselp_mjj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_119'${fidAnaName}'.root","ssww_wwseln_mjj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{jj}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_120'${fidAnaName}'.root","ssww_wwselpn_mjj",0, '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_121'${fidAnaName}'.root","ssww_wwselp_mll",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_122'${fidAnaName}'.root","ssww_wwseln_mll",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{ll}","GeVBINBinWidth","done_ana/histossww_'${YEAR}'_123'${fidAnaName}'.root","ssww_wwselpn_mll",0, '${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,1,"'${mlfitResult}'","'${channelName}'")';

  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta#phi_{jj}","","done_ana/histossww_'${YEAR}'_124'${fidAnaName}'.root","ssww_wwsel_dphijj",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeV","done_ana/histossww_'${YEAR}'_125'${fidAnaName}'.root","ssww_wwsel_met",0,'${YEAR}',"'${legendBSM}'",1.0,'${isBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{ll}","","done_ana/histossww_'${YEAR}'_126'${fidAnaName}'.root","ssww_wwsel_ptll",0,'${YEAR}',"'${legendBSM}'",1.0,0,"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta #phi_{ll}","","done_ana/histossww_'${YEAR}'_131'${fidAnaName}'.root","ssww_wwsel_dphill",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"#Delta R_{ll}","","done_ana/histossww_'${YEAR}'_132'${fidAnaName}'.root","ssww_wwsel_drll",0,  '${YEAR}',"'${legendBSM}'",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'")';
