...
class StandardPlot_exo19003 {

    public: 
        StandardPlot_exo19003() { _doApplyBinWidth = false; _hist.resize(nPlotCategories,0); _hist[kPlotData] = 0; _breakdown = false; _HiggsLabel = ""; _Higgs2Label = "";_labelEM = " Nonprompt";_labelVVV = " VVV";}
  ...
  TH1F* getDataHist() { return _hist[kPlotData]; }
		...
		if(higgsLabel.Contains("m_{H} = 1200")) furtherXOffSet = -0.11;
