...
if [ $NSEL == 'zhg' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeVBINBinWidthStack","done_datacards/histoDatacard_zh_0j_'${YEAR}'.root","zh_0j_met_stack",1,'${YEAR}',"Z(ll)h_{125}(inv.)",'${sf_dy}','${isBlinded}',"0 jet category",1,'${APPLYSCALING}',"","",0,"ana_zh_frozen/histoZH_2019_0j_ADDMonoZ_MD_2_d_4.root","ADD n=4,M_{D}=2 TeV")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"p_{T}^{miss}","GeVBINBinWidthStack","done_datacards/histoDatacard_zh_1j_'${YEAR}'.root","zh_1j_met_stack",1,'${YEAR}',"Z(ll)h_{125}(inv.)",'${sf_dy}','${isBlinded}',"1 jet category",1,'${APPLYSCALING}',"","",0,"ana_zh_frozen/histoZH_2019_1j_ADDMonoZ_MD_2_d_4.root","ADD n=4,M_{D}=2 TeV")';
  ...
  export YEAR=2016;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_datacards/histoDatacard_wz_'${YEAR}'.root","wz_met",1,'${YEAR}',"Z(ll)h_{125}(inv.)",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2017;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_datacards/histoDatacard_wz_'${YEAR}'.root","wz_met",1,'${YEAR}',"Z(ll)h_{125}(inv.)",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2018;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"Emulated p_{T}^{miss}","GeVBINBinWidth","done_datacards/histoDatacard_wz_'${YEAR}'.root","wz_met",1,'${YEAR}',"Z(ll)h_{125}(inv.)",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  ...
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"card","","done_datacards/histoDatacard_vbfg_trigger'${TRIG}'_'${YEAR}'.root","vbfg_trigger'${TRIG}'_sel_card",1,'${YEAR}',"H_{125}(inv.+#gamma) x 0.05",1,'${isBlinded}',"",1,'${APPLYSCALING}')';
  ...
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_sr_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_sr_mtg_mjj'${MJJ}'_trigger'${TRIG}'",0,'${YEAR}',"H_{125}(inv.+#gamma) x 0.05",1,'${isBlinded}',"",1,'${APPLYSCALING}')';
  ...
  export YEAR=2016; export MJJ=0; export TRIG=0;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'",1,'${YEAR}',"H_{125}(inv.+#gamma) x 0.05",1,'${isBlinded}',"",1,'${APPLYSCALING}')';
  export YEAR=2016; export MJJ=1; export TRIG=0;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'",1,'${YEAR}',"H_{125}(inv.+#gamma) x 0.05",1,'${isBlinded}',"",1,'${APPLYSCALING}')';
  export YEAR=2017; export MJJ=0; export TRIG=0;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'",1,'${YEAR}',"H_{125}(inv.+#gamma) x 0.05",1,'${isBlinded}',"",1,'${APPLYSCALING}')';
  ...
  export YEAR=2016;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat3L_'${YEAR}'.root","zh_3l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2017;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat3L_'${YEAR}'.root","zh_3l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2018;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat3L_'${YEAR}'.root","zh_3l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"3-lepton control region",1,'${APPLYSCALING}',"","")';
  ...
  export YEAR=2016;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat4L_'${YEAR}'.root","zh_4l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"4-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2017;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat4L_'${YEAR}'.root","zh_4l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"4-lepton control region",1,'${APPLYSCALING}',"","")';
  export YEAR=2018;
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_cat4L_'${YEAR}'.root","zh_4l_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"4-lepton control region",1,'${APPLYSCALING}',"","")';
  ...
  export YEAR=2019;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_0jBSM_'${YEAR}'.root","zh_0jsignal_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"0-jet signal category",1,'${APPLYSCALING}',"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINStack","done_datacards/histoDatacard_zhmt_0jBSM_'${YEAR}'.root","zh_0jsignal_mt_stack",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"0-jet signal category",1,'${APPLYSCALING}',"","")';
  ...
  export YEAR=2019;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBIN","done_datacards/histoDatacard_zhmt_1jBSM_'${YEAR}'.root","zh_1jsignal_mt",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"1-jet signal category",1,'${APPLYSCALING}',"","")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot.C+'(0,1,"m_{T}","GeVBINStack","done_datacards/histoDatacard_zhmt_1jBSM_'${YEAR}'.root","zh_1jsignal_mt_stack",1,'${YEAR}',"m_{H},m_{a} = 1200,300 GeV",'${sf_dy}','${isBlinded}',"1-jet signal category",1,'${APPLYSCALING}',"","")';
