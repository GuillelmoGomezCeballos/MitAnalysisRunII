...
if [ $NSEL == 'zhg' ]; then
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_hig20017.C+'(0,1,"Bin",       "BIN",           "done_datacards/histoDatacard_hpp_hp'${fidAnaName}'_'${YEAR}'.root",  "ssww_datacardhiggs",1,       '${YEAR}',"H^{++}(500)#rightarrowW^{+}W^{+}, s_{H}=1",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"","",0,"","H^{+}(500)#rightarrowW^{+}Z, s_{H}=1")';
  ...
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_hig20017.C+'(0,1,"m_{T}^{WW}","GeVBIN",        "done_ana/histossww_'${YEAR}'_135'${fidAnaName}'.root","ssww_wwsel_higgs_fullmtww",0,'${YEAR}',"H^{++}(500)#rightarrowW^{+}W^{+}, s_{H}=1",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"","H^{+}(500)#rightarrowW^{+}Z, s_{H}=1")';
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_hig20017.C+'(0,1,"m_{T}^{WZ}","GeVBIN",        "done_ana/histossww_'${YEAR}'_138'${fidAnaName}'.root","ssww_wzsel_higgs_fullmtwz",0,'${YEAR}',"H^{++}(500)#rightarrowW^{+}W^{+}, s_{H}=1",1.0,'${isNeverBlinded}',"",1,'${APPLYSCALING}',"'${mlfitResult}'","'${channelName}'",0,"","H^{+}(500)#rightarrowW^{+}Z, s_{H}=1")';
