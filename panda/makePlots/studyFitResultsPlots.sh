...
if [ $NSEL == 'zhg' ]; then
  ...
  #root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_sr_mtg_trigger'${TRIG}'_'${YEAR}'.root","vbfg_sr_mtg_125_1000_trigger'${TRIG}'",0,'${YEAR}',"qqH_{125}(inv.+#gamma)",1,'${isBlinded}',"",1,'${APPLYSCALING}',"","",0,"done_vbfg/histoVBFG_2019_trigger2_mH125_05.root","qqH_{1000}(inv.+#gamma)")';
  export YEAR=2019; export MJJ=0; export TRIG=2;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_sr_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_sr_mtg_mjj'${MJJ}'_trigger'${TRIG}'",0,'${YEAR}',"qqH_{125}(inv.+#gamma)",1,'${isBlinded}',"m_{jj} < 1500 GeV",1,'${APPLYSCALING}')';
  ...
  export YEAR=2019; export MJJ=0; export TRIG=2;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'",1,'${YEAR}',"qqH_{125}(inv.+#gamma)",1,'${isBlinded}',"m_{jj} < 1500 GeV",1,'${APPLYSCALING}')';
  export YEAR=2019; export MJJ=1; export TRIG=2;
  root -q -b -l MitAnalysisRunII/panda/makePlots/finalPlot_vbfg.C+'(0,1,"m_{T}","GeVBINBinWidth","done_datacards/histoDatacard_vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'_'${YEAR}'.root","vbfg_wj_mtg_mjj'${MJJ}'_trigger'${TRIG}'",1,'${YEAR}',"qqH_{125}(inv.+#gamma)",1,'${isBlinded}',"m_{jj} > 1500 GeV",1,'${APPLYSCALING}')';
