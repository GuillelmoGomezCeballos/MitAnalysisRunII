...
class StandardPlot_hig20017 {

    public: 
        StandardPlot_hig20017() { _doApplyBinWidth = false; _hist.resize(nPlotCategories,0); _hist[kPlotData] = 0; _breakdown = false; _HiggsLabel = ""; _Higgs2Label = "";_labelEM = " Nonprompt";_labelVVV = " VVV";}
  ...
  TH1F* getDataHist() { return _hist[kPlotData]; }
		...
		g->Draw("P,z");
   	    ...
   	    //pt->Draw();
            ...
            if (gPad->GetLogy()) {
                hstack->SetMaximum(100000 * theMax);
