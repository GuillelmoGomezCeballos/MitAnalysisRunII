...
#include "StandardPlot_hig20017.C"
#include "GoodStyle.C"
...
void finalPlot_hig20017(int nsel = 0, int ReBin = 1, TString XTitle = "N_{jets}", TString units = "", TString plotName = "histoWW_56.root", TString outputName = "njets",
  ...
  GoodStyle();
  //gROOT->LoadMacro("StandardPlot_hig20017.C");
  gStyle->SetOptStat(0);

  TH1F* _hist[nPlotCategories];
  StandardPlot_hig20017 myPlot;
  ...
  for(int ic=0; ic<nPlotCategories; ic++){
    ...
    else if(isVBS[0] == 2 && ic == kPlotBSM     && _hist[ic]->GetSumOfWeights() < 0.1) {_hist[ic]->Scale(0);}
    else if(isVBS[0] == 2 && ic == kPlotSignal1 && _hist[ic]->GetSumOfWeights() < 0.1) {_hist[ic]->Scale(0);}

    else if(isVBS[0] == 2 && ic == kPlotSignal1) {_hist[kPlotSignal0]->Add(_hist[ic]);_hist[ic]->Scale(0);}
  ...
  if(strcmp(outputName.Data(),"ssww_datacardhiggs") == 0) _hist[kPlotBSM]->SetBinContent(36,0);

  myPlot.Draw(ReBin);
  CMS_lumi( pad1, year, 1);
  
  if(strcmp(outputName.Data(),"ssww_datacardhiggs") == 0){
    double maxLevel = 3000;
    TLine* baseline0 = new TLine(31.5, 0.001, 31.5, maxLevel); baseline0->SetLineStyle(kDashed); baseline0->Draw();
    TLine* baseline1 = new TLine(45.5, 0.001, 45.5, maxLevel); baseline1->SetLineStyle(kDashed); baseline1->Draw();
    TLine* baseline2 = new TLine(49.5, 0.001, 49.5, maxLevel); baseline2->SetLineStyle(kDashed); baseline2->Draw();
    TLine* baseline3 = new TLine(53.5, 0.001, 53.5, maxLevel); baseline3->SetLineStyle(kDashed); baseline3->Draw();
    TLatex *extraLabel0 = new TLatex(0.350, 0.40, "W^{+}W^{+} SR");
    extraLabel0->SetNDC();
    extraLabel0->SetTextAlign(13);
    extraLabel0->SetTextFont(62);
    extraLabel0->SetTextSize(0.050);
    extraLabel0->Draw();
    TLatex *extraLabel1 = new TLatex(0.650, 0.40, "WZ SR");
    extraLabel1->SetNDC();
    extraLabel1->SetTextAlign(13);
    extraLabel1->SetTextFont(62);
    extraLabel1->SetTextSize(0.050);
    extraLabel1->Draw();
    TLatex *extraLabel2 = new TLatex(0.810, 0.33, "Nonprompt lepton CR");
    extraLabel2->SetNDC();
    extraLabel2->SetTextAlign(13);
    extraLabel2->SetTextFont(62);
    extraLabel2->SetTextSize(0.027);
    extraLabel2->SetTextAngle(90);
    extraLabel2->Draw();
    TLatex *extraLabel3 = new TLatex(0.865, 0.33, "tZq CR");
    extraLabel3->SetNDC();
    extraLabel3->SetTextAlign(13);
    extraLabel3->SetTextFont(62);
    extraLabel3->SetTextSize(0.027);
    extraLabel3->SetTextAngle(90);
    extraLabel3->Draw();
    TLatex *extraLabel4 = new TLatex(0.905, 0.33, "ZZ CR");
    extraLabel4->SetNDC();
    extraLabel4->SetTextAlign(13);
    extraLabel4->SetTextFont(62);
    extraLabel4->SetTextSize(0.027);
    extraLabel4->SetTextAngle(90);
    extraLabel4->Draw();
  }
