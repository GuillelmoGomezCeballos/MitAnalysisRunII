...
void finalPlot_hig20017(int nsel = 0, int ReBin = 1, TString XTitle = "N_{jets}", TString units = "", TString plotName = "histoWW_56.root", TString outputName = "njets",
  ...
  if(strcmp(outputName.Data(),"ssww_datacardhiggs") == 0){
    ...
    extraLabel1->Draw();
    TLatex *extraLabel2 = new TLatex(0.810, 0.29, "Nonprompt lepton CR");
    extraLabel2->SetNDC();
    ...
    extraLabel2->Draw();
    TLatex *extraLabel3 = new TLatex(0.865, 0.29, "tZq CR");
    extraLabel3->SetNDC();
    ...
    extraLabel3->Draw();
    TLatex *extraLabel4 = new TLatex(0.905, 0.29, "ZZ CR");
    extraLabel4->SetNDC();
