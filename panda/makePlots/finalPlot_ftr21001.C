...
#include "StandardPlot_ftr21001.C"
#include "GoodStyle.C"
...
void finalPlot_ftr21001(int nsel = 0, int ReBin = 1, TString XTitle = "N_{jets}", TString units = "", TString plotName = "histoWW_56.root", TString outputName = "njets",
  ...
  GoodStyle();
  //gROOT->LoadMacro("StandardPlot_ftr21001.C");
  gStyle->SetOptStat(0);

  TH1F* _hist[nPlotCategories];
  StandardPlot_ftr21001 myPlot;
