...
*/
  ...
  else if(useTwoBDTs == false && (fidAna == 5 || fidAna == 9)) nBinMVAAux =   nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + nBinMJJCR + 3*nBinMJJCR;
  else if(useTwoBDTs == true  && (fidAna == 5 || fidAna == 9)) nBinMVAAux = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + nBinMJJCR + 3*nBinMJJCR;
  ...
  for(int thePlot=0; thePlot<allPlots; thePlot++){
    ...
    else if(thePlot >=  52 && thePlot <=  53) for(int i=0; i<nPlotCategories; i++) histo[thePlot][i] = new TH1D(Form("histo_%d_%d",thePlot,i), Form("histo_%d_%d",thePlot,i), nBinWWLXBDT0, xbinsWWLXBDT0);
    ...
    else if(thePlot >=  89 && thePlot <=  90) for(int i=0; i<nPlotCategories; i++) histo[thePlot][i] = new TH1D(Form("histo_%d_%d",thePlot,i), Form("histo_%d_%d",thePlot,i), nBinWWLXBDT0, xbinsWWLXBDT0);
    ...
    else if(thePlot >= 153 && thePlot <= 153) for(int i=0; i<nPlotCategories; i++) histo[thePlot][i] = new TH1D(Form("histo_%d_%d",thePlot,i), Form("histo_%d_%d",thePlot,i), nBinWWLXBDT0, xbinsWWLXBDT0);
 ...
 TMVA::Reader *theReaderWWLX1 = new TMVA::Reader("Silent");
  ...
  for(UInt_t ifile=0; ifile<infileName_.size(); ifile++) {
	...
	if(1){
      ...
      if(passEWKWZSel)       histo[         52][theCategory]->Fill(TMath::Max(-0.999, TMath::Min(bdtWWLXValue0[0],0.999)),totalWeight);
      if(passWZbSel)         histo[         53][theCategory]->Fill(TMath::Max(-0.999, TMath::Min(bdtWWLXValue0[0],0.999)),totalWeight);
      ...
      if(passWWSel)          histo[         89][theCategory]->Fill(TMath::Max(-0.999, TMath::Min(bdtWWLXValue0[0],0.999)),totalWeight);
      if(passBtagSel)        histo[         90][theCategory]->Fill(TMath::Max(-0.999, TMath::Min(bdtWWLXValue0[0],0.999)),totalWeight);
	...
	histo[150][theCategory]->Fill((vZ1l1.Pt()*vZ1l2.Pt())/(vJot1.Pt()*vJot2.Pt()),totalWeight);
      ...
      if(passWWSel && bdtWWWSValue[0] > 0) histo[153][theCategory]->Fill(TMath::Max(-0.999, TMath::Min(bdtWWLXValue0[0],0.999)),totalWeight);
	...
	vLoose[0].Pt(),vLoose[0].Eta(),vLoose[0].Phi(),vLoose[1].Pt(),vLoose[1].Eta(),vLoose[1].Phi(),vLoose[2].Pt(),vLoose[2].Eta(),vLoose[2].Phi(),bdtWZValue);
	  ...
	  for(int ib=0; ib<nBinMJJCR; ib++){
	     if(TMath::Min(massJJJERDown,xbinsMJJCR[nBinMJJCR]-0.001) < xbinsMJJCR[ib+1]) {typeSelAux1CR[4] = ib; break;}
          ...
          if(useTwoBDTs == false){
          int whichBin = 0;
          if     (dataCardSel        == 0) MVAVar        = typeSelAux1CR[whichBin] + nBinMJJCR*bdtWWLXValue0Bin[whichBin] + nBinMJJCR*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSel        == 1) MVAVar        = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +               typeSelAux1CR[whichBin];
          else if(dataCardSel        == 2) MVAVar        = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSel        == 3) MVAVar        = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSel        == 4) MVAVar        = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 1;
          if     (dataCardSelJESUp   == 0) MVAVarJESUp   = typeSelAux1CR[whichBin] + nBinMJJCR*bdtWWLXValue0Bin[whichBin] + nBinMJJCR*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJESUp   == 1) MVAVarJESUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +	       typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 2) MVAVarJESUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 3) MVAVarJESUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 4) MVAVarJESUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 2;
          if     (dataCardSelJESDown == 0) MVAVarJESDown = typeSelAux1CR[whichBin] + nBinMJJCR*bdtWWLXValue0Bin[whichBin] + nBinMJJCR*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJESDown == 1) MVAVarJESDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +	       typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 2) MVAVarJESDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 3) MVAVarJESDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 4) MVAVarJESDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 3;
          if     (dataCardSelJERUp   == 0) MVAVarJERUp   = typeSelAux1CR[whichBin] + nBinMJJCR*bdtWWLXValue0Bin[whichBin] + nBinMJJCR*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJERUp   == 1) MVAVarJERUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +	       typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 2) MVAVarJERUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 3) MVAVarJERUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 4) MVAVarJERUp   = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 4;
          if     (dataCardSelJERDown == 0) MVAVarJERDown = typeSelAux1CR[whichBin] + nBinMJJCR*bdtWWLXValue0Bin[whichBin] + nBinMJJCR*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJERDown == 1) MVAVarJERDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +	       typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 2) MVAVarJERDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 3) MVAVarJERDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 4) MVAVarJERDown = nBinMJJCR*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];
          } else {
          int whichBin = 0;
          if     (dataCardSel        == 0) MVAVar        = bdtWWWSValueBin[whichBin] + nBinWWWSBDT*bdtWWLXValue0Bin[whichBin] + nBinWWWSBDT*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSel        == 1) MVAVar        = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +               typeSelAux1CR[whichBin];
          else if(dataCardSel        == 2) MVAVar        = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSel        == 3) MVAVar        = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSel        == 4) MVAVar        = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];
	  //printf("sss %d %d %d %d %d %d\n",dataCardSel,(int)MVAVar,(int)bdtWWWSValueBin[whichBin],(int)bdtWWLXValue0Bin[whichBin],(int)bdtWWLXValue1Bin[whichBin],(int)typeSelAux1CR[whichBin]);

          whichBin = 1;
          if     (dataCardSelJESUp   == 0) MVAVarJESUp   = bdtWWWSValueBin[whichBin] + nBinWWWSBDT*bdtWWLXValue0Bin[whichBin] + nBinWWWSBDT*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJESUp   == 1) MVAVarJESUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +		 typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 2) MVAVarJESUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 3) MVAVarJESUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESUp   == 4) MVAVarJESUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 2;
          if     (dataCardSelJESDown == 0) MVAVarJESDown = bdtWWWSValueBin[whichBin] + nBinWWWSBDT*bdtWWLXValue0Bin[whichBin] + nBinWWWSBDT*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJESDown == 1) MVAVarJESDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +		 typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 2) MVAVarJESDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 3) MVAVarJESDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJESDown == 4) MVAVarJESDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 3;
          if     (dataCardSelJERUp   == 0) MVAVarJERUp   = bdtWWWSValueBin[whichBin] + nBinWWWSBDT*bdtWWLXValue0Bin[whichBin] + nBinWWWSBDT*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJERUp   == 1) MVAVarJERUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +		 typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 2) MVAVarJERUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 3) MVAVarJERUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERUp   == 4) MVAVarJERUp   = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];

          whichBin = 4;
          if     (dataCardSelJERDown == 0) MVAVarJERDown = bdtWWWSValueBin[whichBin] + nBinWWWSBDT*bdtWWLXValue0Bin[whichBin] + nBinWWWSBDT*nBinWWLXBDT0*bdtWWLXValue1Bin[whichBin];
          else if(dataCardSelJERDown == 1) MVAVarJERDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +		 typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 2) MVAVarJERDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 +   nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 3) MVAVarJERDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 2*nBinMJJCR + typeSelAux1CR[whichBin];
          else if(dataCardSelJERDown == 4) MVAVarJERDown = nBinWWWSBDT*nBinWWLXBDT0*nBinWWLXBDT1 + 3*nBinMJJCR + typeSelAux1CR[whichBin];
          }
        }
        else if(fidAna == 6){
          double typeSelAux0[5] = {0,0,0,0,0};
