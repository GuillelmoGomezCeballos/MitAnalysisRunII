...
/*bool thePass =
(thePandaFlat.runNumber==315366&&thePandaFlat.eventNumber==165561611)||
(thePandaFlat.runNumber==315366&&thePandaFlat.eventNumber==339631657)||
	...
	dilepJet = dilepJet + vJetTemp;
     ...
     passZMass && passNjets && passMETTight && passPTFrac && passDPhiZMETTight && passBtagVeto && passPTLL && passDPhiJetMET && passTauVeto
      ...
      if(isDEBUG && passAllCuts[ZHTIGHTSEL] && theCategory == kPlotData) {
        printf("DATA: %d %llu %d %d | %f %d %f %f %f %f %f | %d %d %d %d %d %d %d %d %d %d\n",thePandaFlat.runNumber,thePandaFlat.eventNumber,thePandaFlat.lumiNumber,lepType,
