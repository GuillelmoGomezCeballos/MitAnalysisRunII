...
void mergeVBSHist(TString wwPath = "wwframe") {
...
_filesEWKWWNEW[0] = TFile::Open(Form("%s/WWjj_SS_long_%s.root", inputFolder.Data(),wwPath.Data()));
_filesEWKWWNEW[1] = TFile::Open(Form("%s/WWjj_SS_lt_%s.root"  , inputFolder.Data(),wwPath.Data()));
_filesEWKWWNEW[2] = TFile::Open(Form("%s/WWjj_SS_tt_%s.root"  , inputFolder.Data(),wwPath.Data()));
...
if(wwPath.Contains("wwframe")){
  printf("wwframe\n");
  xsEWKWWNEW[0] = 0.003193; // ll
  xsEWKWWNEW[1] = 0.009288; // lt
  xsEWKWWNEW[2] = 0.016670; // tt
}
...
TH1D *hDIEWKWWNEWMJJQCD[nFilesEWKWWNEW];  TH1D *hDIEWKWWNEWMJJQCD_PDF[nFilesEWKWWNEW];  TH1D *hDIEWKWWNEWMJJQCD_QCD[nFilesEWKWWNEW];	 
...
for(int i=0; i<nFilesEWKWWNEW; i++){
  ...
  hDIEWKWWNEWMJJQCD[i]      = (TH1D*)_filesEWKWWNEW[i]->Get("hDSSWWMJJQCD");      hDIEWKWWNEWMJJQCD[i]     ->Sumw2(); hDIEWKWWNEWMJJQCD[i]     ->Scale(xsEWKWWNEW[i]/hDITotalMCWeightEWKWWNEW[i]->GetSumOfWeights());
  hDIEWKWWNEWMJJQCD_PDF[i]  = (TH1D*)_filesEWKWWNEW[i]->Get("hDSSWWMJJQCD_PDF");  hDIEWKWWNEWMJJQCD_PDF[i] ->Sumw2(); hDIEWKWWNEWMJJQCD_PDF[i] ->Scale(xsEWKWWNEW[i]/hDITotalMCWeightEWKWWNEW[i]->GetSumOfWeights());
  hDIEWKWWNEWMJJQCD_QCD[i]  = (TH1D*)_filesEWKWWNEW[i]->Get("hDSSWWMJJQCD_QCD");  hDIEWKWWNEWMJJQCD_QCD[i] ->Sumw2(); hDIEWKWWNEWMJJQCD_QCD[i] ->Scale(xsEWKWWNEW[i]/hDITotalMCWeightEWKWWNEW[i]->GetSumOfWeights());
...
TH1D *hDEWKWWNEWMJJQCD      = (TH1D*)hDIEWKWWNEWMJJQCD     [0]->Clone("hDEWKWWNEWMJJQCD"    );
TH1D *hDEWKWWNEWMJJQCD_PDF  = (TH1D*)hDIEWKWWNEWMJJQCD_PDF [0]->Clone("hDEWKWWNEWMJJQCD_PDF");
TH1D *hDEWKWWNEWMJJQCD_QCD  = (TH1D*)hDIEWKWWNEWMJJQCD_QCD [0]->Clone("hDEWKWWNEWMJJQCD_QCD");
...
for(int i=1; i<nFilesEWKWWNEW; i++){
  hDEWKWWNEWMJJQCD    ->Add(hDIEWKWWNEWMJJQCD    [i]); 
  hDEWKWWNEWMJJQCD_PDF->Add(hDIEWKWWNEWMJJQCD_PDF[i]);   
  hDEWKWWNEWMJJQCD_QCD->Add(hDIEWKWWNEWMJJQCD_QCD[i]);   
...
diff[0] = 1000*(hDEWKWWNEWMJJQCD_PDF->GetSumOfWeights()-hDEWKWWNEWMJJQCD->GetSumOfWeights());
diff[1] = 1000*(hDEWKWWNEWMJJQCD_QCD->GetSumOfWeights()-hDEWKWWNEWMJJQCD->GetSumOfWeights());
printf("hDEWKWWNEWMJJQCD: %.2f %.2f %.2f (%.2f)\n",1000*hDEWKWWNEWMJJQCD->GetSumOfWeights(),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));
for(int i=1; i<=hDEWKWWNEWMJJQCD->GetNbinsX();i++){
  diff[0] = 1000*(hDEWKWWNEWMJJQCD_PDF->GetBinContent(i)-hDEWKWWNEWMJJQCD->GetBinContent(i));
  diff[1] = 1000*(hDEWKWWNEWMJJQCD_QCD->GetBinContent(i)-hDEWKWWNEWMJJQCD->GetBinContent(i));
  printf("hDEWKWWNEWMJJQCD(%d): %.2f %.2f %.2f (%.2f)\n",i,1000*hDEWKWWNEWMJJQCD->GetBinContent(i),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));
}
...
diff[0] = 1000*((hDIEWKWWNEWMJJQCD_PDF[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_PDF[1]->GetSumOfWeights()+hDIEWKWWNEWMJJ_PDF[2]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()+hDIEWKWWNEWMJJ[2]->GetSumOfWeights()));
diff[1] = 1000*((hDIEWKWWNEWMJJQCD_QCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_QCD[1]->GetSumOfWeights()+hDIEWKWWNEWMJJ_QCD[2]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()+hDIEWKWWNEWMJJ[2]->GetSumOfWeights()));
printf("hDEWKXX: %.3f %.3f %.3f (%.3f)\n",1000*(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()+hDIEWKWWNEWMJJ[2]->GetSumOfWeights()),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));

diff[0] = 1000*((hDIEWKWWNEWMJJQCD_PDF[0]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()));
diff[1] = 1000*((hDIEWKWWNEWMJJQCD_QCD[0]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()));
printf("hDEWKLL: %.3f %.3f %.3f (%.3f)\n",1000*(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));

diff[0] = 1000*((hDIEWKWWNEWMJJ_PDF[2]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_PDF[1]->GetSumOfWeights())-(hDIEWKWWNEWMJJ[2]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()));
diff[1] = 1000*((hDIEWKWWNEWMJJ_QCD[2]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_QCD[1]->GetSumOfWeights())-(hDIEWKWWNEWMJJ[2]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()));
printf("hDEWKTX: %.3f %.3f %.3f (%.3f)\n",1000*(hDIEWKWWNEWMJJ[2]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));

diff[0] = 1000*((hDIEWKWWNEWMJJQCD_PDF[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_PDF[1]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()));
diff[1] = 1000*((hDIEWKWWNEWMJJQCD_QCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD_QCD[1]->GetSumOfWeights())-(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()));
printf("hDEWKLX: %.3f %.3f %.3f (%.3f)\n",1000*(hDIEWKWWNEWMJJQCD[0]->GetSumOfWeights()+hDIEWKWWNEWMJJQCD[1]->GetSumOfWeights()),diff[0],diff[1],TMath::Sqrt(TMath::Power(diff[0],2)+TMath::Power(diff[1],2)));
